...
export default function RegisterPage() {
  return (
    <div className="dark flex min-h-screen items-center justify-center bg-[#000000] px-4 py-8">
      <div className="w-full max-w-2xl">
        ...
        <div className="rounded-xl border border-border bg-card p-8">
          <h2 className="mb-6 text-lg font-semibold text-foreground">Register</h2>
          <RegisterForm />
